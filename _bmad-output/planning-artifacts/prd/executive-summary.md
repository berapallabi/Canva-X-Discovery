...
4. **Deferred Auth & Onboarding:** Users read through a distinct Onboarding sequence, and can configure settings/preview their post before connecting their X account — consistent with Canva's documented deferred authentication pattern (`validityState: "invalid_authentication_required"`).
